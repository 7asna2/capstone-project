    ...
    public void getLocation() {
        ...
        if (isGPSEnabled ){
            if(isNetworkEnabled) {
                ...
                snackbar = Snackbar
                        .make(coordinatorLayout, getString(R.string.no_network), Snackbar.LENGTH_INDEFINITE)
            ...
            snackbar = Snackbar
                    .make(coordinatorLayout, getString(R.string.no_location), Snackbar.LENGTH_INDEFINITE)
                    .setAction("retry", new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            showSettingsAlert();
